...
/// </summary>
public sealed record MessageEndsWith : Expectation
{
    ...
    /// <summary>
    /// The string to compare to the substring at the end of the exception message.
    /// </summary>
    ...
    public MessageEndsWith(string value)
    {
    ...
    public bool Equals(MessageEndsWith other)
    {
    ...
    public bool IsMatch(string actualMessage)
        => actualMessage != null && actualMessage.EndsWith(Value, ComparisonType);
    ...
    public override string ToString()
        => ToString("Message", "ends with", Value, nameof(ComparisonType), OriginalComparisonType);
}